...
class Cs_sidebar(CommonUtils):
    ...
    * 27.07.2017
    ...
    DATA_NAME_SECURITYSERVERS_SECURITY_SERVERS = (By.CSS_SELECTOR, u'a[data-name="securityservers"]') # x: 20 y: 198 width: 99 height: 18, tag: a, type: , name: securityservers, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_GROUPS_GLOBAL = (By.CSS_SELECTOR, u'a[data-name="groups"]') # x: 20 y: 226 width: 89 height: 18, tag: a, type: , name: groups, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_CENTRAL_SERVICES = (By.CSS_SELECTOR, u'a[data-name="central_services"]') # x: 20 y: 254 width: 99 height: 18, tag: a, type: , name: central_services, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_APPROVED_CAS_CERTIFICATION_SERVICES = (By.CSS_SELECTOR, u'a[data-name="approved_cas"]') # x: 20 y: 282 width: 129 height: 18, tag: a, type: , name: approved_cas, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_TSPS_TIMESTAMPING_SERVICES = (By.CSS_SELECTOR, u'a[data-name="tsps"]') # x: 20 y: 310 width: 143 height: 18, tag: a, type: , name: tsps, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_REQUESTS_MANAGEMENT = (By.CSS_SELECTOR, u'a[data-name="requests"]') # x: 20 y: 413 width: 143 height: 18, tag: a, type: , name: requests, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_CONFIGURATION_MANAGEMENT_GLOBAL = (By.CSS_SELECTOR, u'a[data-name="configuration_management"]') # x: 20 y: 441 width: 128 height: 18, tag: a, type: , name: configuration_management, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_SYSTEM_SETTINGS = (By.CSS_SELECTOR, u'a[data-name="system_settings"]') # x: 20 y: 469 width: 98 height: 18, tag: a, type: , name: system_settings, form_id: , checkbox: , table_id: , href: None
    DATA_NAME_BACKUP_BACK_UP_AND_RESTORE = (By.CSS_SELECTOR, u'a[data-name="backup"]') # x: 20 y: 497 width: 129 height: 18, tag: a, type: , name: backup, form_id: , checkbox: , table_id: , href: None

    # Dynamic objects:
    MEMBERS = (By.LINK_TEXT, u'Members') # x: 20 y: 136 width: 59 height: 18, tag: a, type: , name: , form_id: , checkbox: , table_id: , href: None
