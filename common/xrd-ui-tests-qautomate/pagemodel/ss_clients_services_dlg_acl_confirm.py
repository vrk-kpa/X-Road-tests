...
class Ss_clients_services_dlg_acl_confirm(CommonUtils):
    """
    Pagemodel
    ...
    * 27.07.2017
        | Docstrings updated
    """
    # Pagemodel timestamp: 20151211090124
    # Pagemodel url: https://dev-ss1.palveluvayla.com:4000/clients
    # Pagemodel area: (709, 409, 501, 150)
    ...
    def click_confirm_acl_subject_add(self):
        """
